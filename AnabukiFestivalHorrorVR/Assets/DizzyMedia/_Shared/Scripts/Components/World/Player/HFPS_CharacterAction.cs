...
namespace DizzyMedia.Shared {
            ...
            if(userOptions.lookLock == LockSettings.Unlock){
                ...
                if(lookOptions.updateLookCaps){
                    ...
                    if(lastLook > -1){
                        ...
                        if(actionsStart[lastLook].transform != null){
                        
                            auto.refs.mouseLook.rotationX = actionsStart[lastLook].transform.localEulerAngles.y;
                            auto.refs.mouseLook.rotationY = actionsStart[lastLook].transform.localEulerAngles.z;

                        //transform != null
                        } else {
                        
                            auto.refs.mouseLook.rotationX = actionsStart[lastLook].rotation.x;
                            auto.refs.mouseLook.rotationY = actionsStart[lastLook].rotation.y;
                ...
                if(auto.refs.subActionsHandler != null){
                    ...
                    if(state){
                            ...
                            for(int at = 0; at < extensions.subActionSettings.actionTypes.Count; at++) {
                                ...
                                for(int sa = 0; sa < auto.refs.subActionsHandler.subActions.Count; sa++) {
                                    ...
                                    if(extensions.subActionSettings.actionTypes[at].type == auto.refs.subActionsHandler.subActions[sa].type){
                                        ...
                                        if(auto.refs.subActionsHandler.subActions[sa].action != null && auto.refs.subActionsHandler.subActions[sa].action.requireItem){
                                        
                                            if(Inventory.Instance.CheckItemInventory(auto.refs.subActionsHandler.subActions[sa].action.itemID)){
                                        ...
                                        //canAdd
                                            ...
                                            auto.refs.subActionsHandler.subActions[sa].isActive = false;
                                            auto.refs.subActionsHandler.subActions[sa].inputSlot = -1;
                        ...
                        for(int sa = 0; sa < auto.refs.subActionsHandler.subActions.Count; sa++) {
                            ...
                            for(int it = 0; it < auto.refs.subActionsHandler.inputTypes.Count; it++){

                                for(int ai = 0; ai < auto.refs.subActionsHandler.inputTypes[it].actionInputs.Count; ai++) {

                                    if(auto.refs.subActionsHandler.subActions[sa].inputSlot == ai){

                                        auto.refs.subActionsHandler.inputTypes[it].actionInputs[ai].isActive = true;
                        ...
                        auto.refs.subActionsHandler.InputCheck_Type();
                        
                        auto.refs.subActionsHandler.InputIcons_Reset();
                        auto.refs.subActionsHandler.InputCheck_Icons();
    ...
    ///////////////////////////////
            ...
            public void Teleport_Level(){

                auto.gameManager.ChangeScene_Loader(levelName, (int)loadState);

            }//Teleport_Level

            public void Teleport_Level(string newLevel){

                if(newLevel != ""){

                    auto.gameManager.ChangeScene_Loader(newLevel, (int)loadState);
