...
namespace DizzyMedia.Extension {
    ...
    //////////////////////////////////////
        ...
        public class SubActions_Options {
                ...
                public List<HFPS_SubActionsHandler.ActionInput_Type> actionInputTypes = new List<HFPS_SubActionsHandler.ActionInput_Type>();
    ...
    ///////////////////////////////////////
        ...
        private static Vector2 windowsSize = new Vector2(450, 650);
    ...
    ///////////////////////////////////////
        ...
        public void PlayerCreator_Screen(){
            ...
            SerializedProperty characterTypeRef = serializedObject.FindProperty("characterType");
            SerializedProperty createTypeRef = serializedObject.FindProperty("createType");

            SerializedProperty characterRef = serializedObject.FindProperty("character");
            SerializedProperty templateRef = serializedObject.FindProperty("template");

            SerializedProperty createPos = serializedObject.FindProperty("createOptions.createPos");

            SerializedProperty playerLayoutRef = serializedObject.FindProperty("playerLayout");
            SerializedProperty playerAnimatorRef = serializedObject.FindProperty("playerAnimator");

            SerializedProperty limbVisibleLayer = serializedObject.FindProperty("playerCreateOptions.limbVisibleLayer");
            SerializedProperty invisibleLayer = serializedObject.FindProperty("playerCreateOptions.invisibleLayer");
            SerializedProperty invisibleParts = serializedObject.FindProperty("playerCreateOptions.invisibleParts");
            SerializedProperty activateLimbs = serializedObject.FindProperty("playerCreateOptions.activateLimbs");
            SerializedProperty deactivateLimbs = serializedObject.FindProperty("playerCreateOptions.deactivateLimbs");
            SerializedProperty spineBones = serializedObject.FindProperty("playerCreateOptions.spineBones");

            SerializedProperty headCenter = serializedObject.FindProperty("ragdollOptions.headCenter");
            SerializedProperty headDirection = serializedObject.FindProperty("ragdollOptions.headDirection");

            SerializedProperty sources = serializedObject.FindProperty("audioFaderOptions.sources");

            SerializedProperty cameras = serializedObject.FindProperty("fovOptions.cameras");
            SerializedProperty camStates = serializedObject.FindProperty("fovOptions.states");

            SerializedProperty bodyParts = serializedObject.FindProperty("matContOptions.bodyParts");

            SerializedProperty slowDownUse = serializedObject.FindProperty("playerManOptions.slowDownUse");
            SerializedProperty meleeConts = serializedObject.FindProperty("playerManOptions.meleeConts");
            SerializedProperty weaponConts = serializedObject.FindProperty("playerManOptions.weaponConts");

            SerializedProperty proneCenter = serializedObject.FindProperty("proneOptions.proneCenter");

            SerializedProperty zoomType = serializedObject.FindProperty("zoomType");

            SerializedProperty subActionsRef = serializedObject.FindProperty("subActionsOptions.subActions");
            SerializedProperty actionInputTypes = serializedObject.FindProperty("subActionsOptions.actionInputTypes");
            SerializedProperty inputType = serializedObject.FindProperty("subActionsOptions.inputType");

            //SerializedProperty dualWieldItemsRef = serializedObject.FindProperty("dualWieldItems");
    ...
    //////////////////////////////////////
                        ...
                        if(updateOptions.subActsOpts){
                            ...
                            if(subActionsAuto.inputOpts){
                                ...
                                EditorGUILayout.PropertyField(actionInputTypes, true);
                ...
                if(addOrUpdateOptions.addSubActions){
                    ...
                    if(tempScriptMan != null){
                        ...
                        if(!present){
                            ...
                            if(subActionsOptions.actionInputTypes.Count > 0){
                                
                                if(tempSubActs.inputTypes.Count > 0){
                                 
                                    for(int ait = 0; ait < subActionsOptions.actionInputTypes.Count; ait++){
                                        
                                        if(!SubActInput_Check(tempSubActs.inputTypes, subActionsOptions.actionInputTypes[ait].name)){

                                            tempSubActs.inputTypes.Add(subActionsOptions.actionInputTypes[ait]);

                                        }//!sub action not present
                                        
                                    }//for ait actionInputTypes
                                    
                                //inputTypes.Count > 0
                                } else {
                                    
                                    tempSubActs.inputTypes = new List<HFPS_SubActionsHandler.ActionInput_Type>();
    ...
    /////////////
                    ...
                    template.subActionsOptions.actionInputTypes = new List<HFPS_SubActionsHandler.ActionInput_Type>();
                    ...
                    if(subActionsOptions.actionInputTypes.Count > 0){
                        ...
                        for(int i = 0; i < subActionsOptions.actionInputTypes.Count; i++){
                         
                            template.subActionsOptions.actionInputTypes.Add(subActionsOptions.actionInputTypes[i]);
                            
                        }//for i actionInputTypes
    ...
    /////////////
                    ...
                    subActionsOptions.actionInputTypes = new List<HFPS_SubActionsHandler.ActionInput_Type>();
                    ...
                    if(template.subActionsOptions.actionInputTypes.Count > 0){
                     
                        for(int i = 0; i < template.subActionsOptions.actionInputTypes.Count; i++){
                         
                            subActionsOptions.actionInputTypes.Add(template.subActionsOptions.actionInputTypes[i]);
    ...
    ///////////////////////////////////////
            ...
            public bool SubActInput_Check(List<HFPS_SubActionsHandler.ActionInput_Type> subActsInputs, string name){
