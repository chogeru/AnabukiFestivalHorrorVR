...
namespace DizzyMedia.HFPS_Components {
    ...
    //////////////////////////
        ...
        public override void OnInspectorGUI() {
            ...
            SerializedProperty inputTypes = serializedObject.FindProperty("inputTypes");
            ...
            if(subActsHand.tabs == 0){
                ...
                if(subActsHand.genOpts){
                    ...
                    subActsHand.createInstance = EditorGUILayout.Toggle("Create Instance?", subActsHand.createInstance);
                ...
                if(subActsHand.actOpts){
                    ...
                    EditorGUILayout.PropertyField(inputTypes, true);
            ...
            if(subActsHand.tabs == 1){
                ...
                subActsHand.auto.curAction = EditorGUILayout.IntField("Current Action", subActsHand.auto.curAction);
                subActsHand.auto.tempInt = EditorGUILayout.IntField("Temp Int", subActsHand.auto.tempInt);
                subActsHand.auto.tempITSlot = EditorGUILayout.IntField("Temp Input Type Slot", subActsHand.auto.tempITSlot);

                EditorGUILayout.Space();

                subActsHand.auto.isHolding = EditorGUILayout.Toggle("Is Holding?", subActsHand.auto.isHolding);
                subActsHand.auto.curHoldTime = EditorGUILayout.FloatField("Cur Hold Time", subActsHand.auto.curHoldTime);
                subActsHand.auto.tempFill = EditorGUILayout.FloatField("Temp Fill", subActsHand.auto.tempFill);

                EditorGUILayout.Space();

                subActsHand.auto.locked = EditorGUILayout.Toggle("Locked?", subActsHand.auto.locked);
                subActsHand.auto.lockDelay = EditorGUILayout.FloatField("Lock Delay", subActsHand.auto.lockDelay);
